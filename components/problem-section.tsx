  ...
  return (
    <section className="bg-bg-primary py-20 md:py-32">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <h2 className="text-3xl md:text-4xl font-black tracking-tight text-text-primary leading-tight max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          {cards.map((card) => (
            <div
              key={card.num}
              className="bg-bg-secondary border border-border-color border-t-2 border-t-accent-gold rounded-2xl p-6 md:p-8"
            >
              <span className="block text-lg font-black text-accent-gold">
                {card.num}
              </span>
              <h3 className="text-lg md:text-xl font-bold text-text-primary mt-3">
                {card.title}
              </h3>
